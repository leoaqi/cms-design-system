            ...
            <table class="min-w-full bg-white border-none table-auto overflow-scroll w-full">
                ...
                <tbody class="py-4">
                    <tr v-for="(row, index) in filterdBranchs" :key="index">
                        ...
                        <td class="py-5 px-4 border-b text-content-2 font-normal w-auto lg:w-[180px]">{{ row.branchName }}</td>
                        <td class="py-5 px-4 border-b text-content-2 font-normal w-auto lg:w-[250px]">{{ row.relatedDepartment }}</td>
                        <td class="py-5 px-4 border-b text-content-2 font-normal w-auto lg:w-[350px]">{{ row.address }}</td>
