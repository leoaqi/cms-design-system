<template>
    ...
    <div class="grid grid-cols-3 gap-8 py-4">
        <div class="w-full bg-white rounded-xl border border-natural200 px-6 py-4">
            ...
            <div class="flex flex-row justify-between">
                <h5 class="text-heading-5 font-medium">Rp 239.000.000</h5>
        ...
        <div class="w-full bg-white rounded-xl border border-natural200 px-6 py-4">
            ...
            <div class="flex flex-row justify-between">
                <h5 class="text-heading-5 font-medium">500</h5>
            </div>
    ...
    <div class="grid grid-cols-3 gap-8">
        ...
        <div class=" w-full min-h-screen bg-white rounded-md border border-natural200 p-6">
            ...
            <template v-for="(values, index) in depositData" :key="values">
                ...
                <div v-if="index < depositData.length - 1" class="h-[1px] w-full bg-natural200 my-4"></div>
        ...
        <div class="w-full col-span-2 gap-4 flex flex-col">
                ...
                <div class="pb-6">
                    ...
                    <div class="relative h-48">
                        ...
                        <div class="relative h-full flex items-end justify-between px-4">
                            <template v-for="(values) in chartData">
                            ...
                            <div class="absolute inset-y-6 inset-0 h-full flex items-end justify-between px-4 ">
                                <template v-for="(values, month) in chartData" :key="month">
                                    <div class="flex flex-col items-center group">
                                        <!-- Stacked bars container -->
            ...
            <div class="grid grid-cols-2 gap-8 h-full">
                ...
                <div class=" bg-white rounded-xl border border-natural200 py-4 px-4">
                    ...
                    <template v-for="(values, index) in dataTopSpending" :key="values">
